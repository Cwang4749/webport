        ...
        <div>
            <Link to="/AboutMe">
                <span className="bubble" id="aboutme">
                    ...
                    <p1 className="bubble_text"> Background <br/> Hobbies <br/> Fun Facts </p1>
                </span>
            </Link>
            <Link to="/Portfolio">
                <span className="bubble" id="portfolio">
                    <h1 className="bubble_heading"> Portfolio </h1>
                    <p1 className="bubble_text"> C++ <br/> React <br/> Flutter </p1>
                </span>
            </Link>
            <Link to="/Contact">
                <span className="bubble" id="contact">
                    <h1 className="bubble_heading"> Contact </h1>
                    <p1 className="bubble_text"> LinkedIn <br/> Email <br/> Github </p1>
                </span>
            </Link>
            <Link to="/Experience">
                <span className="bubble" id="experience">
                    <h1 className="bubble_heading"> Experience </h1>
                    <p1 className="bubble_text"> Education <br/> Work <br/> Skills </p1>
                </span>
            </Link>
