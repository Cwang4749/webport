...
function AboutMe() {
    ...
    const flashcards = [
        ...
        {
            description: ["My brother and I became 1st degree black belts after years of physical and mental training. Even after years of not training, the muscle memory and the life lessons that I learned still persist.", "I learned how to solve the rubik’s cube through YouTube. My record is 27 seconds. In addition, I learned how to knit through YouTube and I have knitted scarves for my family such as my mom and my little cousin."],
